...
export default class ProfileView extends React.Component {
  ...
  onRemoveFavorite = (movie) => {
    ...
    axios
      .delete(
        `https://marcey-flix-movie-app.herokuapp.com/users/${username}/movies/${movie}`,
        { headers: { Authorization: `Bearer ${token}` } }
      )
      .then((response) => {
        console.log(response);
        alert("Movie was removed from favorite list.");
  ...
  getUser = (token) => {
    const Username = localStorage.getItem("user");
    axios
      .get(`https://marcey-flix-movie-app.herokuapp.com/users/${Username}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
        this.setState({
  ...
  editUser = (e) => {
    ...
    axios
      .put(
        `https://marcey-flix-movie-app.herokuapp.com/users/${Username}`,
  ...
  onDeleteUser() {
    ...
    axios
      .delete(`https://marcey-flix-movie-app.herokuapp.com/users/${Username}`, {
        headers: { Authorization: `Bearer ${token}` },
      })
      .then((response) => {
        console.log(response);
